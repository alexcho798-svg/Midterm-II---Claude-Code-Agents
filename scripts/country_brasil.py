"""Generate a financial profile for Brasil from data/latam_finanzas_clean.csv."""

import pandas as pd

CSV_PATH = r"C:\Users\moni0\OneDrive\Documentos\Midterm II - Claude Code & Agents\data\latam_finanzas_clean.csv"
COUNTRY = "Brasil"
